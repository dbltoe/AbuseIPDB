...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        try {
            ...
            // Create necessary tables, preserving existing data using IF NOT EXISTS
            $this->executeInstallerSql(
            ...
            ); // Preserves existing data in abuseipdb_cache table
            $this->executeInstallerSql(
            ...
            ); // Preserves existing data in abuseipdb_maintenance table
            $this->executeInstallerSql(
            ...
            ); // Preserves existing data in abuseipdb_flood table
